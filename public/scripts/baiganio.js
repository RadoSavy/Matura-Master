document.addEventListener('DOMContentLoaded', function () {
  ...
  const knowledgeBase = {
    ...
    'глаголни времена': {
      ...
      examples: [
        'Той четяше (минало несвършено)',
        'Той е чел (минало неопределено)',
        'Той щеше да чете (бъдеще в миналото)',
      ],
    ...
    причастия: {
      ...
      examples: [
        'Четейки книгата (деепричастие)',
        'Прочетената книга (минало страдателно)',
      ],
    },
    наречие: {
      answer:
    ...
    изречение: {
      ...
      examples: [
        'Ученикът (подлог) чете (сказуемо) книга (допълнение) внимателно (обст. пояснение)',
      ],
    },
    'сложни изречения': {
      answer:
      ...
      examples: [
        'Четях книга, а той гледаше телевизия (съчинено).',
        'Като влезе в стаята, всички млъкнаха (подчинено).',
      ],
    ...
    'масова комуникация': {
      answer:
        'Масовата комуникация достига до огромна аудитория чрез медии: интернет, ТВ, радио, вестници. Характеристики:\n• Широка аудитория\n• Медиен посредник\n• Публичност\n• Информативност\nВидове медийни текстове:\n• Информационна бележка\n• Репортаж\n• Интервю',
      examples: ['Новини', 'Репортажи', 'Интервюта'],
      rules: ['Фактичност', 'Актуалност', 'Обективност'],
    },
    'информационна бележка': {
      answer:
        'Информационната бележка е кратък медиен текст с:\n• Фактичност\n• Краткост\n• Актуалност\n• Обективност\n• Отговори на въпросите: Какво? Къде? Кога?\n• Без коментари и оценки',
      examples: [
        'Новина за спортно събитие',
        'Съобщение за обществено събитие',
        'Кратко съобщение за ново откритие',
      ],
      rules: ['Без коментари', 'Ясни факти', 'Кратък формат', 'Обективност'],
    },
    'репортаж детайли': {
      answer:
        'Репортажът е авторски разказ за събитие с:\n• Актуалност\n• Образност\n• Емоционалност\n• Факти + лична оценка\n• Описание от място\n• Атмосфера и детайли\n• Авторска гледна точка',
      examples: [
        'Спортен репортаж',
        'Репортаж от протест',
        'Репортаж от празник',
    ...
    'звукови промени': {
      ...
      rules: [
        'Зависи от съседни звукове',
        'Влияе на произношението',
        'Свързано с ударението',
        'Характерно за българския език',
      ],
    },
    'глаголни наклонения': {
      answer:
        'Три вида глаголни наклонения:\n1. Изявително - реално действие (чета, пишеш)\n2. Условно - възможно действие (бих чел, бихте писали)\n3. Повелително - заповед/молба (чети! четете!)\nОбразуване:\n• Изявително - основни глаголни форми\n• Условно - бих + минало свършено деятелно причастие\n• Повелително - прости форми или с частици да/нека',
      examples: [
        'Чета (изявително)',
        'Бих чел (условно)',
        'Чети! (повелително)',
        'Да четеш! (повелително)',
        'Нека чете! (повелително)',
      ],
      rules: [
        'Показва отношението към действието',
        'Определя намерението на говорещия',
        'Зависи от контекста на изречението',
      ],
    },
    'преизказни форми': {
      answer:
      ...
      rules: [
        'За предаване на чужди думи',
        'Изразяване на съмнение или учудване',
        'Често в минало време',
        'Характерно за устна реч',
      ],
    },
    'глаголни времена система': {
      answer:
        'Пълна система на глаголните времена в българския език:\n• Сегашно време (чета, пишеш)\n• Минало несвършено (четях, пишеше)\n• Минало свършено (прочетох, написа)\n• Минало неопределено (съм чел, съм писал)\n• Минало предварително (бях чел, беше писал)\n• Бъдеще време (ще чета, ще пиша)\n• Бъдеще предварително (ще съм чел, ще съм писал)\n• Бъдеще време в миналото (щях да чета, щеше да пише)',
      examples: [
        'четах (минало несвършено)',
        'прочетох (минало свършено)',
        'бях чел (минало предварително)',
        'ще чета (бъдеще)',
        'ще съм чел (бъдеще предварително)',
        'щях да чета (бъдеще в миналото)',
      ],
      rules: [
        'Позиционират действието във времето',
        'Показват последователност на действията',
        'Определят завършеност/незавършеност',
        'Свързани с глаголния вид',
      ],
    },
    'съставно сказуемо': {
      answer:
      ...
      examples: [
        'Той е учител (именно)',
        'Започвам да чета (глаголно)',
        'Тя изглежда щастлива (именно)',
        'Мога да пея (глаголно)',
        'Трябва да уча (глаголно)',
      ],
      rules: [
        'Именната част се членува пълно',
        'В учтива форма - ед.ч. за именната част',
        'Глаголите се съгласуват по лице и число',
      ],
    },
    'обособени части': {
      answer:
      ...
      examples: [
        'Дървото, окапало от листата, стоеше (определение)',
        'Тичаше, уплашено от кучето (обст. пояснение)',
        'Светлокосо, момчето се смееше (определение)',
        'Утре, ще дойда (обст. пояснение)',
      ],
      rules: [
        'Отделят се със запетая',
        'Дават допълнителна информация',
        'Могат да стоят в началото, средата или края на изречението',
        'Подчертават характеристика или обстоятелство',
      ],
    },
    'сложни изречения типове': {
      answer:
        'Подробна класификация на сложните изречения:\n• Съчинени - равноправни части (съюзи: и, а, но, ами, или)\n• Подчинени - главно + подчинено (съюзи: че, когато, ако, защото, тъй като)\n• Смесени - комбинация от съчинени и подчинени\n• Безсъюзни - разделени със запетая, точка и запетая, двоеточие\nСловоред:\n• Подчинено след главното\n• Подчинено предхожда главното\n• Подчинено вмъкнато в главното',
      examples: [
        'Четях книга, а той гледаше ТВ (съчинено)',
        'Като влезе, всички млъкнаха (подчинено)',
        'Реших, че ще му кажа, ако ми обещае (смесено)',
        'Влезе, всички млъкнаха (безсъюзно)',
      ],
      rules: [
        'Подчинените се отделят със запетая',
        'Словоредът зависи от смисъла',
        'Съюзите определят вида на връзката',
      ],
    },
    'чужда реч форми': {
      answer:
    ...
    'таблици работа': {
      ...
      examples: [
        'Таблица с успехи на ученици',
        'Таблица с исторически дати',
        'Таблица със сравнителни характеристики',
        'Таблица с граматични правила',
      ],
      rules: [
        'Ясна организация',
        'Логично подреждане',
    ...
    'есе структура': {
      ...
      examples: [
        "Есе на тема 'Значението на образованието'",
        'Есе за влиянието на технологиите',
        'Есе за ролята на изкуството в живота',
      ],
      rules: [
        'Ясна теза',
        'Логични аргументи',
  ...
  function findBestAnswer(userText) {
    ...
    if (
      lower.includes('масова комуникация') ||
      lower.includes('медии') ||
      lower.includes('медиен текст')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('информационна бележка') ||
      lower.includes('информационен текст') ||
      lower.includes('бележка')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('репортаж') ||
      lower.includes('репортьор') ||
      lower.includes('репортажен')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('интервю') ||
      lower.includes('интервюирам') ||
      lower.includes('интервюта')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('художествен текст') ||
      lower.includes('художествена литература') ||
      lower.includes('художествено произведение')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('лексикални средства') ||
      lower.includes('лексика') ||
      lower.includes('речников състав') ||
      lower.includes('думата като')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('звукови промени') ||
      lower.includes('подвижно ъ') ||
      lower.includes('непостоянно ъ') ||
      lower.includes('променливо я')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('наклонение') ||
      lower.includes('изявително') ||
      lower.includes('условно') ||
      lower.includes('повелително')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('преизказни форми') ||
      lower.includes('преизказвам') ||
      lower.includes('чуто не видяно') ||
      lower.includes('преизказни глаголни')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('глаголни времена') ||
      lower.includes('време на глагола') ||
      lower.includes('минало време') ||
      lower.includes('бъдеще време')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('съставно сказуемо') ||
      lower.includes('именно сказуемо') ||
      lower.includes('глаголно сказуемо') ||
      lower.includes('сказуемо')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('обособени части') ||
      lower.includes('обособено определение') ||
      lower.includes('обособено пояснение') ||
      lower.includes('обособявам')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('сложни изречения') ||
      lower.includes('сложно съчинено') ||
      lower.includes('сложно подчинено') ||
      lower.includes('сложно смесено')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('чужда реч') ||
      lower.includes('пряка реч') ||
      lower.includes('непряка реч') ||
      lower.includes('полупряка реч')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('цитиране') ||
      lower.includes('цитат') ||
      lower.includes('кавички') ||
      lower.includes('предаване на цитат')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('нравствен въпрос') ||
      lower.includes('нравствена тема') ||
      lower.includes('морален въпрос') ||
      lower.includes('нравствено разсъждение')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('преразказ') ||
      lower.includes('преразказвам') ||
      lower.includes('преразкажи')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('таблици') ||
      lower.includes('таблица') ||
      lower.includes('табличен') ||
      lower.includes('работа с таблици')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('есе') ||
      lower.includes('съчинение') ||
      lower.includes('есе структура')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('анализ на текст') ||
      lower.includes('анализирам текст') ||
      lower.includes('текстов анализ')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('матура') ||
      lower.includes('подготовка за матура') ||
      lower.includes('матурен изпит')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('жица') ||
      lower.includes('моканин') ||
      lower.includes('негованка')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('глагол') ||
      lower.includes('времена') ||
      lower.includes('спрежен')
    ) {
      return {
        text: formatAnswer(
          knowledgeBase['глаголни времена'].answer,
    ...
    if (
      lower.includes('съществително') ||
      lower.includes('име съществително')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('матура') ||
      lower.includes('съвет') ||
      lower.includes('стратеги')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('сложно изреч') ||
      lower.includes('съчинено изреч') ||
      lower.includes('подчинено изреч')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('стихотворен размер') ||
      lower.includes('стихотворни размери')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('анализ на стихотворен') ||
      lower.includes('стихотворен анализ')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('епическ') ||
      lower.includes('роман') ||
      lower.includes('повест')
    ) {
      return {
        text: formatAnswer(
    ...
    if (
      lower.includes('литература') ||
      lower.includes('книг') ||
      lower.includes('произведени')
    ) {
      return {
